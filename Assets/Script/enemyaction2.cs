	...
	{  
		if(mummylife>0)
		{
			...
			{  
				...
				{
					//敌人进入奔跑状态  
					gameObject.GetComponent<Animation>().Play("walkDamaged");  
			...
			{  
				...
				{  
					...
					{  
						...
						//播放行走动画      
						gameObject.GetComponent<Animation>().Play("walkNormal");  
			...
			case STATE_RUN:  
				...
				break;
			case STATE_ATTACK:
				gameObject.GetComponent<Animation>().Play("bandageWhipAttack1");
				if(canhurt)
				{
